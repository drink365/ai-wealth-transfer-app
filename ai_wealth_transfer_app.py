...
if st.button("計算遺產稅"):
    ...
    st.table(section1.style.set_properties(**{'border': '2px solid black'}))
    ...
    st.table(section2.style.set_properties(**{'border': '2px solid black'}))
    ...
    st.table(section3.style.set_properties(**{'border': '2px solid black'}))
